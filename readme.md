...
`get_calendars.py`. Он вернёт список всех календарей на аккаунте. Либо можно зайти в настройки календаря и найти там
`Интеграция календаря/Идентификатор календаря`. Если не хочется запускать скрипт.
